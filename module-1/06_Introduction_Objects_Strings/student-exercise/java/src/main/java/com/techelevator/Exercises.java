...
public class Exercises
{
	...
	// ** GREGOR IS TEST BROKEN??
	// because if I change the 1 in the if statement to a 2, it still passes.
	...
	// convert str.length(); to an integer
	// divide that int by 2
	// return that
	...
	{
		int minusN = str.length() - n;
		int plusN = str.length() + n;
	...
	/*
	 * Given a string of odd length, (str.length() % 2 == 1)
...
//	Alternative approach found online:
//	

...
public class Exercises
{
	 ...
	 * 
	 * Being asked: 1. Is 6 first? 2. Is 6 last?
	 */
	 ...
	 * 
	 * Being asked: 1. Is the array length >= 1? 2. Are [0] and [array.length-1] the
	 * same?
	 */
	...
	public boolean sameFirstLast(int[] nums)
	{
		...
		boolean areFirstAndLastSame = nums[0] == nums[nums.length - 1];

		return arrayLength && areFirstAndLastSame;
	}
	 ...
	 * 
	 * To do:
	 * 1.) Create an array length == 3
	 * 2.) return sum of all elements
	 */
	 ...
	 * 
	 * To do:
	 * 1.) establish array with 3 elements.
	 * 2.) return "rotated left" elements.
	 */
	
	public int[] rotateLeft3(int[] nums)
	{
		int[] shiftLeft = new int[3];
...
//		return new int[] {nums[1], nums[2], nums[0]};   <- accomplishes the same as above
	 ...
	 * To do:
	 * 1.) establish array with 3 elements.
	 * 2.) replace elements with reverse order.
	 * 
	 */
	 ...
	 * To do:
	 * 1.) array length 3
	 * 2.) Which is larger - [0] or [2]
	 * whichever is larger, rest of elements = that value
	 */

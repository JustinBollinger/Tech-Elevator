...
-- UNION  -- a UNION merges (acts like a DISTINCT) any values that are the same.
UNION ALL -- UNION ALL includes all rows. Means won't merge, will just append the results.

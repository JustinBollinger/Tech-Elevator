...
public class HotelController
{
	...
	// It knows how to do this because we've tagged
	// the MemoryDAO classes with @Component
	...
	// when you have a return void, better to add
	// the @ResponseStatus for NO_CONTENT
	// the only time we call @Valid is when we get
	// info from the body.
	...
	// don't need to @Valid this delete function because
	// we're not getting a body. the @PathVariable takes care of that for us
	// since we can't delete an id that doesn't exist.
	@ResponseStatus(HttpStatus.NO_CONTENT)
	...
	// the @RequestParam here mean that stat IS required, but city is NOT.

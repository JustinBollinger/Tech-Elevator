...
{
  // when I use document, it refers to the entire HTML document.
  // I can narrow my search down by using the .get/.query functions below.
  // returns the <h2> tag with that id
  const title = document.getElementById('page-title');

  // returns the first element with a class "name"
  // if you have multiple elements that fall under the same query,
  // it will pick the first one it finds and ignore the rest.
  ...
  // use the below for a full list of HTML elements
...
function displayReviews()
{
  ...
  // might see something like this during our searches online
  // jQuery
  // const parent = $('main');
}

/**
 * I will be creating a new h4 element with the name of the reviewer and append it to
...
function addRating(parent, numberOfStars)
{
  // div - class = rating
    ...
    // remember that the src is a relative path
